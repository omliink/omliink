...
export default function VisioMeetingNotFound() {
  return (
    <div className="mx-auto max-w-2xl py-16 text-center">
      <h1 className="text-2xl font-bold text-gray-900">Visioconférence introuvable</h1>
      <p className="mt-2 text-sm text-gray-600">Cette visioconférence n&apos;existe pas ou a été supprimée.</p>
      <Link
        href="/dashboard"
