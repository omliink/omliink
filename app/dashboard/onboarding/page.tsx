...
import { getCategories, getCurrentUser, getSkillTaxonomy } from '@/lib/dashboard-data'
...
export default async function OnboardingPage() {
  ...
  const [categories, skillTaxonomy] = await Promise.all([getCategories(), getSkillTaxonomy()])

  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-4xl rounded-xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
